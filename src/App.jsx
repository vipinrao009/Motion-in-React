...
function App() {
  ...
  return (
    <div>
      ...
      <div className='p-8 justify-center mt-40'>
      <div className="group relative w-fit">
        <h1 className="text-4xl font-bold text-center p-7 hover:text-blue-400 cursor-pointer">
          Sheriyansh Coding Club
        </h1>
        <span className="absolute bottom-1  w-0 h-1 bg-gradient-to-r from-blue-600 to-red-600 group-hover:w-full transition-all duration-300"></span>
      </div>
